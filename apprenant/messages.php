...
<body>
        ...
        <div class="sidebar-menu">
            ...
            <li class="side-dashboard" onclick="window.location.assign('index.php')">
                ...
                <li class="side-messages" onclick="window.location.assign('messages.php')">
                    <a class="active"><span class="las la-sms"></span>
                               <span>Message</span>
                    </a>
                </li>
    ...
    <div class="main-content">
        ...
        <main>
            ...
            $n = $db->query("SELECT * from messages where receiver= $stud");
            foreach ($n as $key) { ?>
                <div class="message">
                <?php
                     echo '<span>'.$key['contenu'].'</span>';
                     if($key['links']){
                         $links = $key['links'];
                         echo "<a href='".$links."'> Rejoindre maintenant</a><br/>";
                     }else{
                         echo "<br/>";
                     }
                ?>
