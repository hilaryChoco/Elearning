        ...
        <main class="formations">
            ...
            <div class="formations-body">
                ...
                <div class="formations-card">
                   <?php echo "<img src='../".$formation['photo']."' alt='' width='298px' height='160px'>"; ?>
                    <p style="text-transform:capitalize"><?= $formation['libelle']; ?></p>
                    <span class="price" style="font-weight:bold; text-align:center"><?= $formation['prix']; ?> XAF</span>
                    <span class="createdAt"><u style="font-weight:bold">Date création: </u><?= $formation['date_creation']; ?></span>
                    <span class="autor" style="text-transform:capitalize"><u style="font-weight:bold">Auteur: </u> <?= $formation['cree_par']; ?></span>
