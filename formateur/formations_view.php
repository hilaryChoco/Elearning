...
<body>
    <div style="width:100%; height:100vh">
        <div class="modal">
            <span class="closebtn" onclick="document.querySelector('.modal').style.display='none' "><i class="las la-times"></i></span>
            <div class="submodal">
                <i class="fa fa-times closebtn" aria-hidden="true" onclick="document.querySelector('.modal').style.display='none'"></i>
                <h3 style="margin-bottom:40px; text-align:center; margin-top:50px">Quelle option désirez-vous? :</h3>
                <div class="options">
                    <span class="sub_options" onclick="window.location.assign('test.php')">
                        <i class="las la-video" style="margin-bottom:10px"></i>
                        <span>Visioconférence</span>
                    </span >
                    <span class="sub_options">
                        <i class="lab la-rocketchat" style="margin-bottom:10px"></i>
                        <span>Tchat</span>
                    </span>
                </div>
            </div>
        ...
        <main class="formation_view"> 
            ...
            <div class="formation_view_left">
                ...
                <small style="margin-left:10px; margin-bottom:10px">Prix: <span style="font-weight:bold; color:blue"><?= $key['prix'] ?> XAF</span></small>
            ...
            <div class="formation_view_right">
                ...
                <button class="start_lesson" onclick="startlesson()">Démarrer cours</button>
            </div>
        ...
        <script>
            var isOpen = false;
             function deleteElement(event){
                ...
                http.open('POST','../admin/ajax.php?del_id='+id);
                http.send();
